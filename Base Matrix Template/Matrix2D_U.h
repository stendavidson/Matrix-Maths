...
public:
	 ...
	 */
	Matrix2D_U(std::vector<std::vector<T>> data, m_orientation orientation);
	 ...
	 * @param orientation: The memory orientation of the matrix being created.
	 */
	Matrix2D_U(std::size_t rows, std::size_t cols, m_orientation orientation);
	 ...
	 */
	Matrix2D_U(std::size_t rows, std::size_t cols, m_orientation orientation, T initializer);
	 ...
	 */
	Matrix2D_U(std::size_t rows, std::size_t cols, m_orientation orientation, T(*operation)());
	 ...
	 */
	Matrix2D_U<T> dot_H(Matrix2D_U<T>& matrix);
	...
	* @param matrix: The matrix with which the dot product is being performed.
	*/
	Matrix2D_U<T> dot_V(Matrix2D_U<T>& matrix);
	...
	*/
	Matrix2D_U<T> multiply_H(T scalar);
	...
	* @param scalar: The scalar with which to multiply this matrix.
	*/
	Matrix2D_U<T> multiply_V(T scalar);
	...
	*/
	Matrix2D_U<T> divide_H(T scalar);
	...
	* @param scalar: The scalar with which to divide this matrix.
	*/
	Matrix2D_U<T> divide_V(T scalar);
	...
	*/
	Matrix2D_U<T> add_H(Matrix2D_U<T>& matrix);
	...
	* @param matrix: The matrix with which to add this matrix.
	*/
	Matrix2D_U<T> add_V(Matrix2D_U<T>& matrix);
	...
	*/
	Matrix2D_U<T> subtract_H(T scalar);
	...
	* @param scalar: The scalar with which to subract this matrix.
	*/
	Matrix2D_U<T> subtract_V(T scalar);
	...
	*/
	Matrix2D_U<T> subtract_H(Matrix2D_U<T>& matrix);
	...
	* @param matrix: The matrix with which to subtract this matrix.
	*/
	Matrix2D_U<T> subtract_V(Matrix2D_U<T>& matrix);
	...
	*/
	Matrix2D_U<T> elementwiseApply_H(T(*operation)(T));
	...
	* @param operation: The operation which is performed on the entire array.
	*/
	Matrix2D_U<T> elementwiseApply_V(T(*operation)(T));

	/**
	* This method returns the Matrix2D_U transform of the given matrice.
	*/
	void transform();
...
private:
	...
	* @param orientation: The memory orientation of the matrix being created.
	*/
	Matrix2D_U(T** data, std::size_t rows, std::size_t cols, std::size_t size, m_orientation orientation);
};
...
template<typename T>
T Matrix2D_U<T>::minimum = std::numeric_limits<T>::min();




template<typename T>
T Matrix2D_U<T>::maximum = std::numeric_limits<T>::max();




template<typename T>
T** Matrix2D_U<T>::create_H(std::size_t rows, std::size_t cols, std::size_t size) {
...
template<typename T>
T** Matrix2D_U<T>::create_V(std::size_t rows, std::size_t cols, std::size_t size) {
...
template<typename T>
Matrix2D_U<T>::Matrix2D_U(std::vector<std::vector<T>> data, m_orientation orientation) {
...
template<typename T>
Matrix2D_U<T>::Matrix2D_U(std::size_t rows, std::size_t cols, m_orientation orientation) {
...
template<typename T>
Matrix2D_U<T>::Matrix2D_U(std::size_t rows, std::size_t cols, m_orientation orientation, T initializer) {
...
template<typename T>
Matrix2D_U<T>::Matrix2D_U(std::size_t rows, std::size_t cols, m_orientation orientation, T(*operation)()) {
...
template<typename T>
Matrix2D_U<T>::Matrix2D_U(T** data, std::size_t rows, std::size_t cols, std::size_t size, m_orientation orientation) {
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::dot_H(Matrix2D_U<T>& matrix) {
	...
	Matrix2D_U<T> output(outputMatrix, this->rows, numCols, size, HORIZONTAL);
	...
	for (std::size_t i = 0; i < this->rows; i++) {
		...
		for (std::size_t j = 0; j < numCols; j++) {
			...
			for (std::size_t k = 0; k < numRows; k++) {
				...
				outputMatrix[i][j] += this->matrix[i][k] * externalMatrix[j][k];
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::dot_V(Matrix2D_U<T>& matrix) {
	...
	Matrix2D_U<T> output(outputMatrix, this->rows, numCols, size, VERTICAL);
	...
	for (std::size_t i = 0; i < this->rows; i++) {
		...
		for (std::size_t j = 0; j < numCols; j++) {
			...
			for (std::size_t k = 0; k < numRows; k++) {
				...
				outputMatrix[j][i] += this->matrix[i][k] * externalMatrix[j][k];
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::multiply_H(T scalar) {

	// The output matrix is created
	T** outputMatrix = this->create_H(this->rows, this->cols, this->size);
	Matrix2D_U<T> output(outputMatrix, this->rows, this->cols, this->size, HORIZONTAL);
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::multiply_V(T scalar) {

	// The output matrix is created
	T** outputMatrix = this->create_V(this->rows, this->cols, this->size);
	Matrix2D_U<T> output(outputMatrix, this->rows, this->cols, this->size, VERTICAL);
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::divide_H(T scalar) {
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::divide_V(T scalar) {
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::add_H(T scalar) {
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::add_V(T scalar) {
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::add_H(Matrix2D_U<T>& matrix) {
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::add_V(Matrix2D_U<T>& matrix) {
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::subtract_H(T scalar) {
	...
	return Matrix2D_U<T>::Matrix2D_U(outputMatrix, this->rows, this->cols);
}
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::subtract_V(T scalar) {
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::subtract_H(Matrix2D_U<T>& matrix) {
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::subtract_V(Matrix2D_U<T>& matrix) {
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::min_H(T scalar) {
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::min_V(T scalar) {
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::max_H(T scalar) {
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::max_V(T scalar) {
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::elementwiseApply_H(T(*operation)(T)) {
...
template<typename T>
Matrix2D_U<T> Matrix2D_U<T>::elementwiseApply_V(T(*operation)(T)) {
...
template<typename T>
std::tuple<std::size_t, std::size_t> Matrix2D_U<T>::dimensions() {
...
template<typename T>
m_orientation Matrix2D_U<T>::getOrientation() {
...
template<typename T>
std::string Matrix2D_U<T>::toString() {
